<?php
/**
 * FIX: Cat2 users with real Razorpay autopay should ALWAYS have access
 * (regardless of ends_at date, since autopay auto-renews)
 */
...
echo "✅ Fixed PaywallController - Cat2 users now have ALWAYS access!\n";
